...
func buildTypeNego(nego *TCPNego, session *network.Session) *DataTypeNego {
	...
	result.addTypeRep(types.DATE, types.DATE, TNS_TYPE_REP_ORACLE)
	result.addTypeRep(types.RAW, types.RAW, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(types.LongRaw, types.LongRaw, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(types.ROWID, types.ROWID, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(562, 562, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(types.BInteger, types.NUMBER, TNS_TYPE_REP_ORACLE)
	result.addTypeRep(types.FLOAT, types.NUMBER, TNS_TYPE_REP_ORACLE)
	result.addTypeRep(types.NullStr, types.NCHAR, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(types.VarNum, types.NUMBER, TNS_TYPE_REP_ORACLE)
	result.addTypeRep(types.PDN, types.NUMBER, TNS_TYPE_REP_ORACLE)
	result.addTypeRep(types.VARCHAR, types.NCHAR, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(13, 0, TNS_TYPE_REP_NATIVE)
	result.addTypeRep(14, 0, TNS_TYPE_REP_NATIVE)
	result.addTypeRep(TNS_DATA_TYPE_VBI, 23, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(39, 646, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(TNS_DATA_TYPE_RDD, types.ROWID, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(types.JSON, types.JSON, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(types.VECTOR, types.VECTOR, TNS_TYPE_REP_UNIVERSAL)
	//if (!OracleConfiguration.MapVectorColumnAsClob)
	//{
	//	TTCDataTypeNegotiation.AddTypeRepresentation(127, 0, 127, 1);
	//}
	...
	result.addTypeRep(198, types.VECTOR, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(647, 647, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(611, 611, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(612, 612, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(617, 617, TNS_TYPE_REP_UNIVERSAL)
	...
	result.addTypeRep(899, 899, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(900, 900, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(901, 901, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(646, 646, TNS_TYPE_REP_UNIVERSAL)
	result.addTypeRep(662, 662, TNS_TYPE_REP_UNIVERSAL)
	if len(result.Server.ServerCompileTimeCaps) > 7 {
