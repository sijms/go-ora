...
var tests = []struct {
	...
	},
	{
		name: "1/3",
		args: args{
			[]byte{192, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34},
		},
		want: 1.0 / 3.0,
	},
	{
		name: "-0.33333333333333333333333333333333333333",
		args: args{
			[]byte{63, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 102},
		},
		want: -0.33333333333333333333333333333333333333,
	},
	{
		name: "-0.333333333333333333333333333333333333333",
		args: args{
			[]byte{63, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 68, 71},
		},
...
func TestDecodeDouble2(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := DecodeDouble2(tt.args.inputData)
